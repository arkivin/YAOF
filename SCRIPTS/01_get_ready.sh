...
#rooter_repo="https://github.com/ofmodemsandmen/SourceMaster"
...
git clone https://github.com/ofmodemsandmen/SourceMaster rooter

# 等待所有后台任务完成
wait
cp -rf ./rooter/package/root* ./openwrt/package/
# 进行一些处理
